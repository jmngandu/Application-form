...
function sendData() {
  ...
  urlEncodedDataPairs.push(
    encodeURIComponent("name") +
      "=" +
      encodeURICompovar form = document.getElementsByTagName("form")[0];
      form.addEventListener("submit", function(e) {
        e.preventDefault();
        sendData();
      });
      ...
      function sendData() {
        ...
        function sendData() {
          ...
          urlEncodedDataPairs.push(
            encodeURIComponent("comments") +
              "=" +
              encodvar form = document.getElementsByTagName("form")[0];
form.addEventListener("submit", function(e) {
  e.preventDefault();
  sendData();
});
...
function sendData() {
  ...
  urlEncodedData = var form = document.getElementsByTagName("form")[0];
  form.addEventListener("submit", function(e) {
    e.preventDefault();
    sendData();
  });
...
dDataPairs.push(
      ...
      nent(form.querySelector("[name='name']").value)
  );
  urlEncodedDataPairs.push(
    encodeURIComponent("send_to") +
      "=" +
